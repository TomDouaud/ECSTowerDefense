...
// Équivalent de votre classe Constants.Tiles
pub mod tiles {
...
// Équivalent de votre classe Constants.Enemies
pub mod enemies {
    pub const ORC: u32 = 0;
    pub const BAT: u32 = 1;
    ...
    // ... (vous pouvez ajouter GetStartHealth ici aussi)
}

// Équivalent de votre classe Constants.Towers
pub mod towers {
